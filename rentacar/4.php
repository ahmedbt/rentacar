...
<body ng-controller="myController as myCtrl">
    ...
    <table  style="width: 100%; border: 2px;">
    	...
    	<tr ng-repeat="reservation in reservations | filter: 'ford' | orderBy">
    ...
    <div style="margin-bottom: 15px;"><h3 ng-model="carname" style="width: 50%; margin: auto; text-align: center;">{{cars[3].name}}</h3></div>
    	<img src="{{cars[3].image}}" class="slika">
    ...
    <div>
    	...
    	<blockquote ng-repeat="review in reviews4" style="background-color: #dbecff;">
    	...
    	<div >
    	<b class="slika2">Average rating: {{avg4[0].avgg}}</b>
    	</div>
    	</div>
...
$host = "localhost";
    ...
    if(isset($_POST['save'])){
        ...
        VALUES (4,'".$_POST["stars"]."','".$_POST["textt"]."','".$_POST["email"]."')";
    ...
    ?>
    	...
    	<form action="4.php" method="post" id="myform" name="reviewForm" class="form-group" style="width: 90%; margin: auto; padding-bottom: 55px;">
