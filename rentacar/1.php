...
<body ng-controller="myController as myCtrl">
    ...
    <table  style="width: 100%; border: 2px;">
    	...
    	<tr ng-repeat="reservation in reservations | filter: 'citroen' | orderBy">
    ...
    <div style="margin-bottom: 15px;"><h3 ng-model="carname" style="width: 50%; margin: auto; text-align: center;">{{cars[0].name}}</h3></div>
    	<img src="{{cars[0].image}}" class="slika">
    ...
    <div>
    	...
    	<blockquote ng-repeat="review in reviews" style="background-color: #dbecff;">
    	...
    	<div >
    	<b class="slika2">Average rating: {{avg[0].avgg}}</b>
    	</div>
    	</div>
...
$host = "localhost";
    ...
    if(isset($_POST['save'])){
        ...
        VALUES (1,'".$_POST["stars"]."','".$_POST["textt"]."','".$_POST["email"]."')";
    ...
    ?>
    	...
    	<form action="1.php" method="post" id="myform" name="reviewForm" class="form-group" style="width: 90%; margin: auto; padding-bottom: 55px;">
