...
<body ng-controller="myController as myCtrl">
    ...
    <table  style="width: 100%; border: 2px;">
    	...
    	<tr ng-repeat="reservation in reservations | filter: 'opel' | orderBy">
    ...
    <div style="margin-bottom: 15px;"><h3 ng-model="carname" style="width: 50%; margin: auto; text-align: center;">{{cars[5].name}}</h3></div>
    	<img src="{{cars[5].image}}" class="slika">
    ...
    <div>
    	...
    	<blockquote ng-repeat="review in reviews6" style="background-color: #dbecff;">
    	...
    	<div >
    	<b class="slika2">Average rating: {{avg6[0].avgg}}</b>
    	</div>
    	</div>
...
$host = "localhost";
    ...
    if(isset($_POST['save'])){
        ...
        VALUES (6,'".$_POST["stars"]."','".$_POST["textt"]."','".$_POST["email"]."')";
    ...
    ?>
    	...
    	<form action="6.php" method="post" id="myform" name="reviewForm" class="form-group" style="width: 90%; margin: auto; padding-bottom: 55px;">
